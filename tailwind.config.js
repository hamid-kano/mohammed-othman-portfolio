...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-creative': 'linear-gradient(135deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #f5576c 75%, #4facfe 100%)',
        'gradient-sunset': 'linear-gradient(135deg, #ff6b6b 0%, #ffa726 50%, #42a5f5 100%)',
